...
router.post('/', async (req: { currentUser: { role: string; }; body: { pic: string; city: string; state: string; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message: string; }): any; new(): any; }; }; json: (arg0: any) => void; }) => {
...
router.put('/:placeId', async (req: { currentUser: { role: string }; params: { placeId: any }; body: any }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message: string }): void; new(): any } }; json: (arg0: any) => void }) => {
    if (req.currentUser?.role !== 'admin') {
...
router.delete('/:placeId', async (req: { currentUser: { role: string }; params: { placeId: any } }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message: string }): void; new(): any } }; json: (arg0: any) => void }) => {
    if (req.currentUser?.role !== 'admin') {
...
router.post('/:placeId/comments', async (req: { params: { placeId: any }; body: { rant: boolean }; currentUser: { userId: any } }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message: string }): void; new(): any } }; send: (arg0: any) => void }) => {
...
router.delete('/:placeId/comments/:commentId', async (req: any, res: any) => {
    let placeId = Number(req.params.placeId)
